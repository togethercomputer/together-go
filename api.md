...
- <code title="get /compute/clusters">client.Beta.Clusters.<a href="https://pkg.go.dev/github.com/togethercomputer/together-go#BetaClusterService.List">List</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>) (\*<a href="https://pkg.go.dev/github.com/togethercomputer/together-go">together</a>.<a href="https://pkg.go.dev/github.com/togethercomputer/together-go#BetaClusterListResponse">BetaClusterListResponse</a>, <a href="https://pkg.go.dev/builtin#error">error</a>)</code>
...
- <code title="post /rl/training-sessions">client.Rl.TrainingSessions.<a href="https://pkg.go.dev/github.com/togethercomputer/together-go#RlTrainingSessionService.New">New</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>, body <a href="https://pkg.go.dev/github.com/togethercomputer/together-go">together</a>.<a href="https://pkg.go.dev/github.com/togethercomputer/together-go#RlTrainingSessionNewParams">RlTrainingSessionNewParams</a>) <a href="https://pkg.go.dev/builtin#error">error</a></code>
- <code title="get /rl/training-sessions/{session_id}">client.Rl.TrainingSessions.<a href="https://pkg.go.dev/github.com/togethercomputer/together-go#RlTrainingSessionService.Get">Get</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>, sessionID <a href="https://pkg.go.dev/builtin#string">string</a>) <a href="https://pkg.go.dev/builtin#error">error</a></code>
- <code title="get /rl/training-sessions">client.Rl.TrainingSessions.<a href="https://pkg.go.dev/github.com/togethercomputer/together-go#RlTrainingSessionService.List">List</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>, query <a href="https://pkg.go.dev/github.com/togethercomputer/together-go">together</a>.<a href="https://pkg.go.dev/github.com/togethercomputer/together-go#RlTrainingSessionListParams">RlTrainingSessionListParams</a>) <a href="https://pkg.go.dev/builtin#error">error</a></code>
- <code title="post /rl/training-sessions/{session_id}:forward-backward">client.Rl.TrainingSessions.<a href="https://pkg.go.dev/github.com/togethercomputer/together-go#RlTrainingSessionService.ForwardBackward">ForwardBackward</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>, sessionID <a href="https://pkg.go.dev/builtin#string">string</a>, body <a href="https://pkg.go.dev/github.com/togethercomputer/together-go">together</a>.<a href="https://pkg.go.dev/github.com/togethercomputer/together-go#RlTrainingSessionForwardBackwardParams">RlTrainingSessionForwardBackwardParams</a>) <a href="https://pkg.go.dev/builtin#error">error</a></code>
- <code title="post /rl/training-sessions/{session_id}:optim-step">client.Rl.TrainingSessions.<a href="https://pkg.go.dev/github.com/togethercomputer/together-go#RlTrainingSessionService.OptimStep">OptimStep</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>, sessionID <a href="https://pkg.go.dev/builtin#string">string</a>, body <a href="https://pkg.go.dev/github.com/togethercomputer/together-go">together</a>.<a href="https://pkg.go.dev/github.com/togethercomputer/together-go#RlTrainingSessionOptimStepParams">RlTrainingSessionOptimStepParams</a>) <a href="https://pkg.go.dev/builtin#error">error</a></code>
- <code title="post /rl/training-sessions/{session_id}:stop">client.Rl.TrainingSessions.<a href="https://pkg.go.dev/github.com/togethercomputer/together-go#RlTrainingSessionService.Stop">Stop</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>, sessionID <a href="https://pkg.go.dev/builtin#string">string</a>) <a href="https://pkg.go.dev/builtin#error">error</a></code>

### Operations

Methods:

- <code title="get /rl/training-sessions/{session_id}/operations/forward-backward/{operation_id}">client.Rl.TrainingSessions.Operations.<a href="https://pkg.go.dev/github.com/togethercomputer/together-go#RlTrainingSessionOperationService.GetForwardBackward">GetForwardBackward</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>, operationID <a href="https://pkg.go.dev/builtin#string">string</a>, query <a href="https://pkg.go.dev/github.com/togethercomputer/together-go">together</a>.<a href="https://pkg.go.dev/github.com/togethercomputer/together-go#RlTrainingSessionOperationGetForwardBackwardParams">RlTrainingSessionOperationGetForwardBackwardParams</a>) <a href="https://pkg.go.dev/builtin#error">error</a></code>
- <code title="get /rl/training-sessions/{session_id}/operations/optim-step/{operation_id}">client.Rl.TrainingSessions.Operations.<a href="https://pkg.go.dev/github.com/togethercomputer/together-go#RlTrainingSessionOperationService.GetOptimStep">GetOptimStep</a>(ctx <a href="https://pkg.go.dev/context">context</a>.<a href="https://pkg.go.dev/context#Context">Context</a>, operationID <a href="https://pkg.go.dev/builtin#string">string</a>, query <a href="https://pkg.go.dev/github.com/togethercomputer/together-go">together</a>.<a href="https://pkg.go.dev/github.com/togethercomputer/together-go#RlTrainingSessionOperationGetOptimStepParams">RlTrainingSessionOperationGetOptimStepParams</a>) <a href="https://pkg.go.dev/builtin#error">error</a></code>
