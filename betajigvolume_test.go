...
func TestBetaJigVolumeNewWithOptionalParams(t *testing.T) {
...
func TestBetaJigVolumeUpdateWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Beta.Jig.Volumes.Update(
		context.TODO(),
		"id",
		together.BetaJigVolumeUpdateParams{
			...
			Type: together.BetaJigVolumeUpdateParamsTypeReadOnly,
		},
	)
	if err != nil {
		var apierr *together.Error
...
func TestBetaJigVolumeList(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Beta.Jig.Volumes.List(context.TODO())
	if err != nil {
		var apierr *together.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestBetaJigVolumeDelete(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Beta.Jig.Volumes.Delete(context.TODO(), "id")
	if err != nil {
		var apierr *together.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
